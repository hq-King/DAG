...
from model.odise.odise.checkpoint.odise_checkpointer import LdmCheckpointer
from model.odise.odise.modeling.meta_arch.clip import ClipAdapter
from model.odise.odise.utils.file_io import PathManager
...
class LatentDiffusion(nn.Module):
    ...
    def load_pretrain(self):
        LdmCheckpointer(self.ldm).load("ckpt/sd/v1-5-pruned-emaonly.ckpt")
