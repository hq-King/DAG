...
class FeatureExtractorBackbone(Backbone):
    ...
    def single_forward(self, afford_name,img):
        ...
        # text_feature = self.feature_extractor.clip._encode_text(afford_name)
    ...
    def slide_forward(self, afford_name,img):
        # print(img.shape)
        ...
        # text_features = self.feature_extractor.clip.encode_text(afford_name)
        ...
        for h_idx in range(h_grids):
            for w_idx in range(w_grids):
                ...
                crop_features = self.single_forward(afford_name,crop_img)
        ...
        return output_features,text_features

    def forward(self, afford_name,img):
        if (self.training and not self._slide_training) or not self._slide_inference:
            return self.single_forward(afford_name,img)
        else:
            return self.slide_forward(afford_name,img)
