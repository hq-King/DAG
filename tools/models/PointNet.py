...
class Pts_Encoder_curvature(nn.Module):
    def __init__(self, normal_channel=False):
        ...
        self.sa3 = PointNetSetAbstraction(npoint=64, radius=0.6, nsample=32, in_channel=512 + 3, mlp=[256, 512, 512], group_all=False)
...
class Pts_Upsample(nn.Module):
    def __init__(self):
        ...
        self.fp3 = PointNetFeaturePropagation(in_channel=512+512, mlp=[512, 256])
